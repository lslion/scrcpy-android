...
import com.dao.ioe.scrcpyclient.adblib.AdbBase64;
import com.dao.ioe.scrcpyclient.adblib.AdbConnection;
import com.dao.ioe.scrcpyclient.adblib.AdbCrypto;
import com.dao.ioe.scrcpyclient.adblib.AdbStream;
...
public class SendCommands {
    ...
    public int SendAdbCommands(Context context, final byte[] fileBase64, final String ip, String localip, int bitrate, int size) {
        ...
        command.append(" CLASSPATH=/data/local/tmp/scrcpy-server.jar app_process / com.dao.ioe.scrcpy.Server ");
